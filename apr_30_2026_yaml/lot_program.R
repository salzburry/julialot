...
# ============================================================
main <- function() {
  # ---- Resolve YAML-backed study config + write resolved dump ----
  ...
  cfg <<- built$cfg   # promote merged cfg to module-level so the rest of the
                      # pipeline (which references `cfg` as a global) sees it.

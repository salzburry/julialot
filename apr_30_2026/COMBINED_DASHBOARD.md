...
- **Run & data quality strip** — study end, **steroid codes as HCPCS + NDC**, category rules, generated time, and per-cohort build status (`built` / `built with warnings` / `unavailable`)

...
build_validation_exploratory <- function(con) {
  ...
  add_html_card(paste0(
    ...
    if (is.null(ster_src)) '<b>Unavailable this run - Q3/Q4/Q5 skipped.</b> ' else '',
    '"Steroid at LOT<i>n</i>" = a steroid claim inside the induction window (',
    VQS_W1, 'd for LOT1, ', VQS_W2, 'd for LOT2).</li>',
    '<li><b>Before/after windows</b> (7/14/30d) are cumulative (&le;N days) ',
    'and measured from a steroid claim date.</li>',

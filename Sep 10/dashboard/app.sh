...
export DASH_PACKAGE_DIR="${DASH_PACKAGE_DIR:-Sep 10/ndmm_study_updated/study223926}"

R -e "shiny::runApp('Sep 10/dashboard', host = '0.0.0.0', port = 8888, launch.browser = FALSE)"

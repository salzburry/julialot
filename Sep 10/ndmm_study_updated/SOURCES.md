...
| its tests | `study223926/tests/run_tests.R` — 412 checks, no warehouse. The last section runs every module against recorders using `study223926/tests/fixtures/codelists/` |

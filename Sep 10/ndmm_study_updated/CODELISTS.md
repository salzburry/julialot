...
`Sep 10/lot/engine/config.csv`). Nothing loads without them: `load_codelist_csv()`
...
### The LOT engine — `Sep 10/lot/engine/R/steps/01_codelists.R`
...
`Sep 10/lot/` has no `safety/` directory at all.

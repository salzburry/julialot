...
```bash
Rscript ndmm_study_updated/study223926/tests/run_tests.R   # 428
Rscript dashboard/tests/run_tests.R                        # 574
Rscript TFLS/tests/test_tfls.R                             # 296
...
2523 checks. Base R throughout — no suite above loads a package. The app needs

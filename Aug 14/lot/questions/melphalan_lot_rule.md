...
also available as a sensitivity on the NDMM cohort - `lot/validation`'s
...
rebuild. `lot/melphalan/` does that: three complete LOT runs - the contract
build and both readings of the rule - and the difference between them.

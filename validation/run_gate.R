...
EXPECTED_FAILURES <- list(
  "validation/port/lot.R" = c(
    ...
    "04_lot1_base.R: differs from 02_lot1.R in 142 line(s)",
    ...
    "06_lot1_end.R: differs beyond the approved deviations in 259 line(s)",
    ...
    "10_lot2_5_base.R: differs from R/lot2_5_base.R in 934 line(s)")
)

...
FRAGMENT <- c(
  ...
  melp_line_type_guard    = "opens with its own newline",
  ...
  supp                    = "spliced after a predicate, opens with its own newline",
  ...
  stock_by_lot_sql        = "spliced after AS and a space, at end of line",
  stock_by_med_sql        = "spliced after AS and a space, at end of line",
  stock_absorbed_add_sql  = "spliced after AS and a space, at end of line",
  rechall_gap_sql         = "spliced after AS and a space, at end of line",
  rechall_by_med_sql      = "spliced after AS and a space, at end of line",

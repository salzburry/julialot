...
cl <- readLines(file.path(GROUP, "engine", "R", "codelists_lot.R"), warn = FALSE)
...
dsh <- readLines(file.path(GROUP, "dashboard", "R", "db_utils_dash.R"),
                 warn = FALSE)
...
bl <- readLines(file.path(GROUP, "engine", "R", "build_lot.R"), warn = FALSE)

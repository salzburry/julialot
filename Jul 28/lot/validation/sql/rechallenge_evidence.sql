...
SELECT CASE WHEN COVER_GAP_DAYS IS NULL THEN '0: no prior episode'
...
FROM ranked
WHERE rn = 1
GROUP BY CASE WHEN COVER_GAP_DAYS IS NULL THEN '0: no prior episode'
WHEN COVER_GAP_DAYS <=  7    THEN '1: 1-7d'
WHEN COVER_GAP_DAYS <= 30    THEN '2: 8-30d'
WHEN COVER_GAP_DAYS <= 89    THEN '3: 31-89d'
ELSE                     '4: 90d+' END,
         ...
         ELSE '3: prior episode MAP_DISCON_FLG = 0'
       END
ORDER BY CASE WHEN COVER_GAP_DAYS IS NULL THEN '0: no prior episode'
WHEN COVER_GAP_DAYS <=  7    THEN '1: 1-7d'
WHEN COVER_GAP_DAYS <= 30    THEN '2: 8-30d'
WHEN COVER_GAP_DAYS <= 89    THEN '3: 31-89d'
ELSE                     '4: 90d+' END,

...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_auto_is_a_line",
       ...
       where = "lot/engine/R/steps/05b_lot1_sct.R:118, :140, lot/engine/R/steps/10_lot2_5_base.R:297, :362",
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:360, :496",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:71, lot/engine/R/steps/06_lot1_end.R:206, lot/engine/R/steps/10_lot2_5_base.R:275, :361",
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:248, :275, :297, :361, :362, :400, :414",
  ...
  list(id = "regimen_membership_window",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:307, :395",
  ...
  list(id = "substitution",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:242, :414",
  ...
  list(id = "steroids",
       ...
       ours = paste0("No. Steroids are dropped from the code list, so they ",
                     ...
                     "one alive."),
       where = "lot/engine/R/steps/01_codelists.R:43, lot/engine/R/steps/10_lot2_5_base.R:400",
  ...
  list(id = "line_cap",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:1099, lot/engine/R/build_lot.R:1805",
       proves = c("max_lot"),

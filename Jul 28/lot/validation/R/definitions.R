...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:360, :491",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:71, lot/engine/R/steps/06_lot1_end.R:182, lot/engine/R/steps/10_lot2_5_base.R:275, :361",
  ...
  list(id = "line_cap",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:1099, lot/engine/R/build_lot.R:1777",
       proves = c("max_lot"),

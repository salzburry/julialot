...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_auto_is_a_line",
       ...
       where = "lot/engine/R/steps/05b_lot1_sct.R:101, :123, lot/engine/R/steps/10_lot2_5_base.R:293, :347",
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:345, :458",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:53, lot/engine/R/steps/06_lot1_end.R:186, lot/engine/R/steps/10_lot2_5_base.R:271, :346",
       proves = c("LOT1_BASE_1ST_ADD_MED_DT", "CART", "cart_line_dt"),
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:244, :271, :293, :346, :347, :385, :399",
  ...
  list(id = "regimen_membership_window",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:303, :380",
  ...
  list(id = "substitution",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:238, :399",
  ...
  list(id = "steroids",
       ...
       ours = paste0("No. Steroids are dropped from the code list, so they ",
                     ...
                     "one alive."),
       where = "lot/engine/R/steps/01_codelists.R:43, lot/engine/R/steps/10_lot2_5_base.R:385",
  ...
  list(id = "line_cap",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:1066, lot/engine/R/build_lot.R:1738",
       proves = c("max_lot"),

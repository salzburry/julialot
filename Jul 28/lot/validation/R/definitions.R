...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_auto_is_a_line",
       ...
       where = "lot/engine/R/steps/05b_lot1_sct.R:118, :140, lot/engine/R/steps/10_lot2_5_base.R:295, :360",
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:358, :489",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:27, lot/engine/R/steps/06_lot1_end.R:191, lot/engine/R/steps/10_lot2_5_base.R:273, :361",
  ...
  list(id = "maintenance_is_a_line",
       ...
       where = "lot/engine/R/steps/06_lot1_end.R:17, :53",
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:246, :253, :273, :295, :361, :393, :412",
  ...
  list(id = "regimen_membership_window",
       ...
       ours = paste0("Day 0 through INDUCTION_WINDOW_DAYS - 1 for LOT1, and ",
                     ...
                     "is a fill inside the window, not coverage across it: an ",
                     "episode that opened in the previous line and is still ",
                     "stockpiled into this one does not join, because a patient ",
                     "who has switched is no longer filling the old agent."),
       where = "lot/engine/R/steps/10_lot2_5_base.R:305, :393",
  ...
  list(id = "substitution",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:240, :412",
  ...
  list(id = "steroids",
       ...
       ours = paste0("No. Steroids are dropped from the code list, so they ",
                     ...
                     "one alive."),
       where = "lot/engine/R/steps/01_codelists.R:43, lot/engine/R/steps/10_lot2_5_base.R:398",

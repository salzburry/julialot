...
- rule: lot/engine/R/melp_rule.R:469 - melp_suppress, SHORT = 1 AND CONFIRMED = 0
...
- rule: lot/engine/R/melp_rule.R:454 - datediff(COURSE_END_DT, EXPO_DT) + 1 <= cap
...
- rule: lot/engine/R/melp_rule.R:485 - melp_inject, CONFIRMED = 1, at EXPO_DT

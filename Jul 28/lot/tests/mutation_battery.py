...
SRC = "/home/user/julialot/Jul 28/lot"
WORK = "/tmp/claude-0/-home-user-julialot/548affc2-dd45-5731-a3cd-a13a48e1a7b2/scratchpad/bat"
M = [
...
TESTS = ["tests/test_line_criteria.R","tests/test_runner.R","tests/test_same_as_source.R","tests/test_selfcontained.R"]
miss = []
for name, f, a, b in M:

...
which the engine does at each decision point. The lot README goes further: the
code list itself should not carry them, and ships the tool that removes them.

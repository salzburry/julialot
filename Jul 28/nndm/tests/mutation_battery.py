...
M = [
 ...
 ("override flag ignores the join","R/steps/04_other_malig.R","           CASE WHEN trim(om.tumor_group) IN ({ovr_in}) OR m.dx IS NOT NULL","           CASE WHEN trim(om.tumor_group) IN ({ovr_in})"),

...
M = [
 ...
 ("cohort index from the parent","R/build_nndm.R","      SELECT DISTINCT cast(p.PATID as string) AS PATID, l1.LOT1_START_DT AS INDEX_DATE","      SELECT DISTINCT cast(p.PATID as string) AS PATID, d0.INDEX_DATE AS INDEX_DATE"),

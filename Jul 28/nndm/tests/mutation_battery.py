...
M = [
 ...
 ("remission override default off","R/build_nndm.R",'  mm_adjacent_remission = "override",','  mm_adjacent_remission = "exclude",'),
 ("remission labels dropped","R/standalone_constants.R",'NDMM_MM_ADJACENT_REMISSION_LABELS <- c(\n  "SOLITARY PLASMACYTOMA IN REMISSION",','NDMM_MM_ADJACENT_REMISSION_LABELS <- c(\n  "SOLITARY PLASMACYTOMA",'),
 ("remission setting unknown accepted","R/standalone_constants.R",'    stop("NDMM_MM_ADJACENT_REMISSION=\'", NDMM_MM_ADJACENT_REMISSION,','    NDMM_MM_ADJACENT_OVERRIDE) ; if (FALSE) stop("NDMM_MM_ADJACENT_REMISSION=\'", NDMM_MM_ADJACENT_REMISSION,'),
 ("remission setting unpinned","R/build_nndm.R",'  list(const = "NDMM_MM_ADJACENT_REMISSION", cfg = "mm_adjacent_remission", note = ""),\n',''),

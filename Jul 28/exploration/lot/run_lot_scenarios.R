...
OPEN_QUESTIONS <- data.frame(
  ...
  WHAT_THE_CODE_DOES_TODAY = c(
    ...
    paste0("SETTLED on 2026-08-30. A returning prior-line agent now JOINS ",
           "the line it returns in when exactly one agent advanced the line ",
           "between its two doses; two or more and it starts a line as before ",
           "- LOT_RULES.md 4.8. exploration/lot/run_foldin_cells.R measures ",
           "what that changed."),

...
#   INPUT_COHORT_TABLE=ndmm_NDMM_COHORT Rscript exploration/lot/run_sensitivity.R
#
#   # actually run it
#   DATABRICKS_PWD=... INPUT_COHORT_TABLE=ndmm_NDMM_COHORT COHORT_PREFIX=ndmm_ \
#     SENS_EXECUTE=TRUE Rscript exploration/lot/run_sensitivity.R
#
...
print_plan <- function(cells) {
  ...
  cat("Not swept, and why:\n",
      ...
      "                       no maintenance period - see\n",
      "                       lot/engine/R/steps/05_sct.R:13 - so there is\n",
      "                       nothing to vary. It is in the vignettes.\n",

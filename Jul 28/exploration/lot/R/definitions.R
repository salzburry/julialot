...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_auto_is_a_line",
       ...
       where = "lot/engine/R/steps/05b_lot1_sct.R:142, :167, lot/engine/R/steps/10_lot2_5_base.R:340, :408",
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:406, :575",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:27, lot/engine/R/steps/06_lot1_end.R:252, lot/engine/R/steps/10_lot2_5_base.R:306, :407",
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:259, :271, :281, :306, :340, :407, :408",
  ...
  list(id = "regimen_membership_window",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:468, :473, :476",
  ...
  list(id = "substitution",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:259, :495",
  ...
  list(id = "steroids",
       ...
       ours = paste0("No. Steroids are dropped from the code list, so they ",
                     ...
                     "one alive."),
       where = "lot/engine/R/steps/01_codelists.R:43, lot/engine/R/steps/10_lot2_5_base.R:479",

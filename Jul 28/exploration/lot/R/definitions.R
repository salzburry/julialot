...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_auto_is_a_line",
       ...
       where = "lot/engine/R/steps/05b_lot1_sct.R:142, :167, lot/engine/R/steps/10_lot2_5_base.R:358, :456",
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:454, :642",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:27, lot/engine/R/steps/06_lot1_end.R:283, lot/engine/R/steps/10_lot2_5_base.R:323, :455",
  ...
  list(id = "maintenance_is_a_line",
       ...
       where = "lot/engine/R/steps/06_lot1_end.R:19, :58",
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:276, :288, :298, :323, :358, :455, :456",
  ...
  list(id = "gap_ends_a_line",
       ...
       where = "lot/engine/R/steps/03_mma_map.R:402",
  ...
  list(id = "regimen_membership_window",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:517, :522, :525",
  ...
  list(id = "substitution",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:276, :563",
  ...
  list(id = "steroids",
       ...
       ours = paste0("No. Steroids are dropped from the code list, so they ",
                     ...
                     "one alive."),
       where = "lot/engine/R/steps/01_codelists.R:43, lot/engine/R/steps/10_lot2_5_base.R:528",
  ...
  list(id = "line_cap",
       ...
       where = "lot/engine/R/build_lot.R:1818",
       proves = c("max_lot"),

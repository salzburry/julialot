...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_auto_is_a_line",
       ...
       where = "lot/engine/R/steps/05b_lot1_sct.R:142, :167, lot/engine/R/steps/10_lot2_5_base.R:323, :391",
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:389, :547",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:27, lot/engine/R/steps/06_lot1_end.R:244, lot/engine/R/steps/10_lot2_5_base.R:289, :390",
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:254, :262, :269, :289, :323, :390, :391",
  ...
  list(id = "regimen_membership_window",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:451, :456, :459",
  ...
  list(id = "substitution",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:254, :476",
  ...
  list(id = "steroids",
       ...
       ours = paste0("No. Steroids are dropped from the code list, so they ",
                     ...
                     "one alive."),
       where = "lot/engine/R/steps/01_codelists.R:43, lot/engine/R/steps/10_lot2_5_base.R:462",
  ...
  list(id = "line_cap",
       ...
       where = "lot/engine/R/build_lot.R:1800",
       proves = c("max_lot"),

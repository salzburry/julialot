...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:449, :642",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:27, lot/engine/R/steps/06_lot1_end.R:282, lot/engine/R/steps/10_lot2_5_base.R:317, :450",
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = paste0("lot/engine/R/steps/10_lot2_5_base.R:270, :282, :292, ",
                      ":317, :352, :450, :451, :452, lot/engine/R/melp_rule.R:496, :512"),
  ...
  list(id = "line_cap",
       ...
       where = "lot/engine/R/build_lot.R:1828",
       proves = c("max_lot"),

...
LOT_DIMENSIONS <- list(
  ...
  list(id = "sct_auto_is_a_line",
       ...
       where = "lot/engine/R/steps/05b_lot1_sct.R:142, :167, lot/engine/R/steps/10_lot2_5_base.R:361, :460",
  ...
  list(id = "sct_allo_is_a_line",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:458, :648",
  ...
  list(id = "cart_is_a_line",
       ...
       where = "lot/engine/R/cart_rule.R:27, lot/engine/R/steps/06_lot1_end.R:272, lot/engine/R/steps/10_lot2_5_base.R:326, :459",
  ...
  list(id = "what_starts_a_new_line",
       ...
       where = paste0("lot/engine/R/steps/10_lot2_5_base.R:270, :291, :301, ",
                      ...
                      "lot/engine/R/prior_regimen.R:37, lot/engine/R/foldin_rule.R:394"),
  ...
  list(id = "regimen_membership_window",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:525, :526, :529",
  ...
  list(id = "substitution",
       ...
       where = "lot/engine/R/steps/10_lot2_5_base.R:270, lot/engine/R/prior_regimen.R:77",
  ...
  list(id = "steroids",
       ...
       ours = paste0("No. Steroids are dropped from the code list, so they ",
                     ...
                     "one alive."),
       where = "lot/engine/R/steps/01_codelists.R:43, lot/engine/R/steps/10_lot2_5_base.R:532",
  ...
  list(id = "line_cap",
       ...
       where = "lot/engine/R/build_lot.R:1832",
       proves = c("max_lot"),

...
LOT_SCENARIOS <- list(
  ...
  list(id = "S01", group = "A drug that comes back",
       ...
       lines = c("LOT1  d0-d89   MED  MED_ADD          regimen DARA",
                 "LOT2  d90-d250  MED  DISCONTINUATION  regimen LEN"),
       ...
       note = paste0("Two lines. LEN starts outside LOT1's 60-day window, so it is an ",
                     ...
                     "the return joins LOT2. LOT2's span carries it to d250; its ",
                     "regimen string stays LEN."),
  ...
  list(id = "S30", group = "A drug that comes back",
       ...
       lines = c("LOT1  d0-d89   MED  MED_ADD          regimen DARA",
                 "LOT2  d90-d400  MED  DISCONTINUATION  regimen LEN"),
       ...
       note = paste0("This is where the fold-in and the substitute rule meet. A ",
                     ...
                     "advance in that interval, so it folds. S29 is the same swap one ",
                     "line earlier, and gets one line. "),
       sql = NULL,

...
# that nor a local copy is found. It reads the CDM directly and writes NDMM_COH_FINAL to
...
if (!interactive()) build_cohort(here, expect_table = "NDMM_COH_FINAL", expect_prefix = "ndmm_")
